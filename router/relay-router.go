...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.AuditExport(), middleware.Distribute())
	{
	...
	relayV1Router.Use(middleware.AuditExport())
	{
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.AuditExport(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(middleware.AuditExport())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), middleware.AuditExport(), middleware.Distribute())
	{
